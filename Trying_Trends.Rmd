...
# Select out the necessary variables 
  ...
  select(country, year, cow, rusarms_slope, logrusarms_slope, usarms_slope, logusarms_slope, logmil_slope, ideal_slope, loggdp_slope, democ_slope, oil_slope, corrup_slope)
