...
# Select out the necessary variables 
  ...
  select(country, cow, rusarms_slope, usarms_slope, econ_slope, mil_slope, ideal_slope, democ_slope, oil_slope, corrup_slope) %>%
...
```{r results = 'asis'}
regression <- lm(data = trends, formula = ideal_slope ~ rusarms_slope + econ_slope + democ_slope + mil_slope + oil_slope + corrup_slope)
