...
# Select out the necessary variables 
  ...
  select(country, cow, arms_slope, usarms_slope, econ_slope, mil_slope, ideal_slope, democ_slope, oil_slope) %>%
...
```{r}
regression <- lm(data = trends, formula = ideal_slope ~ arms_slope + mil_slope + democ_slope + usarms_slope + oil_slope)
