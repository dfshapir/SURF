...
```{r results = 'asis'}
regression <- lm(data = trends, formula = ideal_slope ~ logrusarms_slope + logusarms_slope + democ_slope + logmil_slope + oil_slope + corrup_slope)

regression2 <- lm(data = trends, formula = ideal_slope ~ rusarms_slope + usarms_slope + democ_slope + logmil_slope + oil_slope + corrup_slope)
